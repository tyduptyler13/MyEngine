#ifndef MYUPLAY_MYENGINE_COLOR
#define MYUPLAY_MYENGINE_COLOR
...
namespace MyUPlay {
	...
	namespace MyEngine {
		...
		enum ColorKeyword { aliceblue = 0xF0F8FF, antiquewhite = 0xFAEBD7, aqua = 0x00FFFF, aquamarine = 0x7FFFD4, azure = 0xF0FFFF,
