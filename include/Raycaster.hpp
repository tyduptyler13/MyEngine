...
public:
	...
	static Vector2<T> uvIntersection(const Vector3<T>& point, const Vector3<T>& p1, const Vector3<T>& p2,
	                                 const Vector3<T>& p3, Vector2<T> uv1, Vector2<T> uv2, Vector2<T> uv3) {
